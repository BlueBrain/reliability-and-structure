...
connectome=load_connectome(data_dir, 'BBP') 
...
compute_all_props(analysis_config, force_recompute=True) # Use force_recompute=False in case the run crashes midcomputation