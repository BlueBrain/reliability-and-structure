...
''' 
Compute neighborhood complexity of Celegans connectome and controls
...
# Load connectome from zenodo download
...
connectome=load_connectome(data_dir, 'Celegans') 
...
analysis_config={'graph': adj,
                 'out_file_prefix' : 'props_Celegans',
                 'seed_CM': 0,
                 ...
                 'controls':{
                     ...
                     # Adding parameters of connectivity
                     'kwargs':{'n':N, 
                               'p':adj.sum()/((N)*(N-1)), 
                               'threads':10,
                               'seed':(10, 10)}},
